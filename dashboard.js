...
function toggleSidebar() {
    ...
    // Show/Hide the burger menu and close icon based on sidebar state
    if (sidebar.classList.contains('open')) {
        burgerMenu.style.display = 'none'; // Hide burger menu
        closeSidebar.style.display = 'inline-block'; // Show close icon
    } else {
        burgerMenu.style.display = 'inline-block'; // Show burger menu
        closeSidebar.style.display = 'none'; // Hide close icon
    }
}

// Add event listeners to the burger menu and close icon
document.querySelector('.burger-menu').addEventListener('click', toggleSidebar);
document.querySelector('.close-icon').addEventListener('click', toggleSidebar);
